...
Vítáme příspěvky od komunity! Pokud chcete přispět, postupujte takto:
...
Pro více informací se podívejte do našeho [průvodce pro přispěvatele](CONTRIBUTING.md).
...
- Všechna citlivá data jsou šifrována
- Osobní údaje jsou zpracovávány v souladu s GDPR
- Pravidelné bezpečnostní audity

Pokud objevíte bezpečnostní zranitelnost, prosím kontaktujte nás na security@digimedic.cz.

## 🚀 Nasazení

Detailní instrukce pro nasazení do produkce najdete v našem [průvodci nasazením](docs/deployment.md).

## 📚 Dokumentace

Podrobná dokumentace je k dispozici v [/docs](docs/) adresáři, včetně:

- [API reference](docs/api.md)
- [Uživatelská příručka](docs/user-guide.md)
- [Průvodce pro vývojáře](docs/development.md)

## 👥 Tým

PillSee je vyvíjen týmem DigiMedic. Více o našem týmu a dalších projektech najdete na [www.digimedic.cz](https://www.digimedic.cz).

## 📬 Kontakt

Pro dotazy nebo podporu nás kontaktujte na [info@digimedic.cz](mailto:info@digimedic.cz).

## 🙏 Poděkování

- [OpenAI](https://openai.com/) za poskytnutí API pro AI model
- [SÚKL](https://www.sukl.cz/) za poskytnutí přístupu k databázi léčiv
- Všem přispěvatelům a beta testerům

---

⚠️ **Důležité upozornění**: PillSee je informační nástroj a nenahrazuje odbornou lékařskou konzultaci. Vždy konzultujte užívání léků s lékařem nebo lékárníkem.
